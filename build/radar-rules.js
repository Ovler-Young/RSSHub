({ "2047.name":{ _name:"2047",
    ...
    ".":[ { title:"Artist",
      ...
      { title:"Recent Posts",
        ...
        source:[ "/posts",
          "/" ],
        target:"/coomer/posts" } ] },
  "www.yinian.pro":{ _name:"一念",
    ".":[ { title:"一念的便签",
        docs:"https://docs.rsshub.app/other.html#yi-nian-zui-xing-bian-qian",
        target:"/copyidea/link/:token" } ] },
  ...
  "course.buct.edu.cn":{ _name:"THEOL",
    ".":[ { title:"THEOL",
        docs:"https://docs.rsshub.app/other.html#yi-nian-zui-xing-bian-qian",
        target:"/theol/link/:token" } ] },
